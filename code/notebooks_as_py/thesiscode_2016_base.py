# Exported from THESISCODE 2016 Base.ipynb. Outputs removed; execution order preserved where present.
...
# %% Cell 19
shapefile_path_gtfs1 = 'C:/Users/m1llz/Downloads/full_greater_sydney_gtfs_static_29082016.zip'
...
travel_time_matrix = r5py.TravelTimeMatrixComputer(
    ...
    departure=datetime.datetime(2016, 8, 29, 8, 00, 00),
...
# %% Cell 30
#opportunities2.to_csv("C:/Users/m1llz/Downloads/opportunities_v3.csv", index=False)

# %% Cell 31
output_path = 'C:/Users/m1llz/Downloads/2016_access_60mins.shp'
opportunities2.to_file(output_path, driver='ESRI Shapefile')
