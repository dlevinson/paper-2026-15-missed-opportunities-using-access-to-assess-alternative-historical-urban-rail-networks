# Exported from lva_alt_metro_v2.ipynb. Outputs removed; execution order preserved where present.
...
# %% Cell 7
gdf3 = gdf[gdf['DISTRICT N'] == 'WAVERLEY']
...
# %% Cell 10
print(joined_access_and_house['DISTRICT N'].unique())
...
aggregate.to_csv('C:/Users/m1llz/Documents/University/Year 5/Sem 2/Thesis/Alternative Metro/With Maroubra/TravelZone_Uplift.csv', index = False)
aggregate

# %% Cell 14
aggregate2 = aggregate[aggregate['TZ16_CODE'] ==300]
