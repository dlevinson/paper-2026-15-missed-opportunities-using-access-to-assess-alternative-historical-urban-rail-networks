# Exported from THESISCODE Mills Plan.ipynb. Outputs removed; execution order preserved where present.
...
# %% Cell 15
trips_txt_path = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_combination_v2/trips.txt'
...
# %% Cell 18
stop_times_txt_path = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_combination_v2/stop_times.txt'
...
def process_trip3(trip_id):
    ...
    new_arrival_time8 = arrival_time8 - timedelta(minutes=15)
    ...
    new_departure_time8 = departure_time8 - timedelta(minutes=15)
    ...
    new_arrival_time = arrival_time - timedelta(minutes=12,seconds=30)
...
def process_trip5(trip_id):
    ...
    arrival_time7 = datetime.strptime(arrival_time_str7, '%H:%M:%S')
    new_arrival_time7 = arrival_time7+ timedelta(minutes=15)
    new_arrival_time_str7 = new_arrival_time7.strftime('%H:%M:%S')
    ...
    filtered_row5['stop_sequence'] =filtered_row4['stop_sequence'] + 6
...
# %% Cell 43
stop_times_txt_data.to_csv("C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_combination_v2/stop_times.txt", index=False)
...
# %% Cell 46
shapefile_path_gtfs1 = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/Mills_V3.zip'
