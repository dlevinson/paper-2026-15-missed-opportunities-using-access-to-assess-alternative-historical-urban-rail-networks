# Exported from THESISCODE 2056Metro-Stage2.ipynb. Outputs removed; execution order preserved where present.
...
# %% Cell 15
trips_txt_path = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_with2056edits/trips.txt'
...
# %% Cell 18
stop_times_txt_path = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_with2056edits/stop_times.txt'
...
def process_trip(trip_id):
    ...
    new_departure_time = departure_time - timedelta(minutes=14)
    ...
    new_arrival_time4 = arrival_time4 - timedelta(minutes=13)
    ...
    new_departure_time4 = departure_time4 - timedelta(minutes=12)
    ...
    new_arrival_time5 = arrival_time5 - timedelta(minutes=11)
    ...
    new_arrival_time6 = arrival_time6 - timedelta(minutes=9)
    ...
    new_arrival_time7 = arrival_time7 - timedelta(minutes=7)
    ...
    new_departure_time7 = departure_time7 - timedelta(minutes=6)
    ...
    new_arrival_time8 = arrival_time8 - timedelta(minutes=5)
    ...
    new_departure_time8 = departure_time8 - timedelta(minutes=4)
    ...
    rows_to_insert = [filtered_row,filtered_row1,filtered_row2,filtered_row3,filtered_row4,filtered_row5]
...
def process_trip1(trip_id):
    ...
    filtered_row['stop_id'] = 2017469
    filtered_row1['stop_id'] = 2031469
    filtered_row2['stop_id'] = 2035469
    filtered_row3['stop_id'] = 2035569
    filtered_row4['stop_id'] = 2036469
    filtered_row5['stop_id'] = 2036569
    
    arrival_time_str = filtered_row['arrival_time'].values[0]
    arrival_time = datetime.strptime(arrival_time_str, '%H:%M:%S')
    new_arrival_time = arrival_time + timedelta(minutes=4)
    new_arrival_time_str = new_arrival_time.strftime('%H:%M:%S')
    filtered_row['arrival_time'] = new_arrival_time_str

    departure_time_str = filtered_row['departure_time'].values[0]
    departure_time = datetime.strptime(departure_time_str, '%H:%M:%S')
    new_departure_time = departure_time + timedelta(minutes=5)
    new_departure_time_str = new_departure_time.strftime('%H:%M:%S')
    filtered_row['departure_time'] = new_departure_time_str
    ...
    new_arrival_time3 = arrival_time3 + timedelta(minutes=6)
    ...
    new_departure_time3 = departure_time3 + timedelta(minutes=7)
    ...
    arrival_time5 = datetime.strptime(arrival_time_str5, '%H:%M:%S')
    new_arrival_time5 = arrival_time5 + timedelta(minutes=10)
    new_arrival_time_str5 = new_arrival_time5.strftime('%H:%M:%S')
    filtered_row3['arrival_time'] = new_arrival_time_str5

    departure_time_str5 = filtered_row3['departure_time'].values[0]
    departure_time5 = datetime.strptime(departure_time_str5, '%H:%M:%S')
    new_departure_time5 = departure_time5 + timedelta(minutes=11)
    new_departure_time_str5 = new_departure_time5.strftime('%H:%M:%S')
...
# %% Cell 39
#stop_times_txt_data.to_csv("C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_with2056edits/stop_times.txt", index=False)

# %% Cell 40
shapefile_path_gtfs1 = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/2056_stage1and2_v2.zip'
