# Exported from THESISCODE Bradfield Proposal Staged_vaucluse.ipynb. Outputs removed; execution order preserved where present.
...
# %% Cell 15
trips_txt_path = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_bradfield_vaucluse/trips.txt'
...
# %% Cell 18
stop_times_txt_path = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_bradfield_vaucluse/stop_times.txt'
...
'''
'''
for trip in range(0, len(trip_ids0), 3):
...
for trip in range(1, len(trip_ids0), 3):
...
# %% Cell 30
#process_trip3('412B.1396.144.40.H.8.81851741')
...
'''
for trip1 in range(0, len(trip_ids2), 3):
...
# %% Cell 46
test_output = stop_times_txt_data[stop_times_txt_data['trip_id']=='621D.1904.101.64.T.8.81040857']
test_output
...
for trip1 in range(1, len(trip_ids2), 3):
...
# %% Cell 52
stop_times_txt_data.to_csv("C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_bradfield_vaucluse/stop_times.txt", index=False)
...
# %% Cell 55
shapefile_path_gtfs1 = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/bradfield_vaucluse_v2.zip'
