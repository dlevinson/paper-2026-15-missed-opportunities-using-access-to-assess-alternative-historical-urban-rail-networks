# Exported from THESISCODE Bradfield Proposal Staged-sydenham and malabar.ipynb. Outputs removed; execution order preserved where present.
...
# %% Cell 15
trips_txt_path = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_bradfield_malabar&sydenham/trips.txt'
...
# %% Cell 18
stop_times_txt_path = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_bradfield_malabar&sydenham/stop_times.txt'
...
def process_trip(trip_id):
    ...
    filtered_row3['stop_id'] = 2020111
    filtered_row4['stop_id'] = 204471

    filtered_row['stop_sequence'] = 5
    filtered_row1['stop_sequence'] = 4
    filtered_row2['stop_sequence'] = 3
    filtered_row3['stop_sequence'] = 2
    filtered_row4['stop_sequence'] = 1


    filtered_row['drop_off_type'] = 0
    filtered_row1['drop_off_type'] = 0
    filtered_row2['drop_off_type'] = 0
    filtered_row3['drop_off_type'] = 0
    
    arrival_time_str = filtered_row4['arrival_time'].values[0]
    arrival_time = datetime.strptime(arrival_time_str, '%H:%M:%S')
    new_arrival_time = arrival_time - timedelta(minutes=12)
    new_arrival_time_str = new_arrival_time.strftime('%H:%M:%S')
    filtered_row4['arrival_time'] = new_arrival_time_str

    departure_time_str = filtered_row4['departure_time'].values[0]
    departure_time = datetime.strptime(departure_time_str, '%H:%M:%S')
    new_departure_time = departure_time - timedelta(minutes=11,seconds=30)
    new_departure_time_str = new_departure_time.strftime('%H:%M:%S')
    filtered_row4['departure_time'] = new_departure_time_str




    arrival_time_str4 = filtered_row3['arrival_time'].values[0]
    arrival_time4 = datetime.strptime(arrival_time_str4, '%H:%M:%S')
    new_arrival_time4 = arrival_time4 - timedelta(minutes=9,seconds=30)
    new_arrival_time_str4 = new_arrival_time4.strftime('%H:%M:%S')
    filtered_row3['arrival_time'] = new_arrival_time_str4

    departure_time_str4 = filtered_row3['departure_time'].values[0]
    departure_time4 = datetime.strptime(departure_time_str4, '%H:%M:%S')
    new_departure_time4 = departure_time4 - timedelta(minutes=9)
    new_departure_time_str4 = new_departure_time4.strftime('%H:%M:%S')
    filtered_row3['departure_time'] = new_departure_time_str4


    arrival_time_str5 = filtered_row2['arrival_time'].values[0]
    arrival_time5 = datetime.strptime(arrival_time_str5, '%H:%M:%S')
    new_arrival_time5 = arrival_time5 - timedelta(minutes=7)
    ...
    new_departure_time5 = departure_time5 - timedelta(minutes=6,seconds=30)
    new_departure_time_str5 = new_departure_time5.strftime('%H:%M:%S')
    filtered_row2['departure_time'] = new_departure_time_str5


    arrival_time_str6 = filtered_row1['arrival_time'].values[0]
    arrival_time6 = datetime.strptime(arrival_time_str6, '%H:%M:%S')
    new_arrival_time6 = arrival_time6 - timedelta(minutes=4)
    new_arrival_time_str6 = new_arrival_time6.strftime('%H:%M:%S')
    filtered_row1['arrival_time'] = new_arrival_time_str6

    departure_time_str6 = filtered_row1['departure_time'].values[0]
    departure_time6 = datetime.strptime(departure_time_str6, '%H:%M:%S')
    new_departure_time6 = departure_time6 - timedelta(minutes=3,seconds=30)
    new_departure_time_str6 = new_departure_time6.strftime('%H:%M:%S')
    filtered_row1['departure_time'] = new_departure_time_str6

    
    arrival_time_str7 = filtered_row['arrival_time'].values[0]
    arrival_time7 = datetime.strptime(arrival_time_str7, '%H:%M:%S')
    new_arrival_time7 = arrival_time7 - timedelta(minutes=2)
    new_arrival_time_str7 = new_arrival_time7.strftime('%H:%M:%S')
    filtered_row['arrival_time'] = new_arrival_time_str7

    departure_time_str7 = filtered_row['departure_time'].values[0]
    departure_time7 = datetime.strptime(departure_time_str7, '%H:%M:%S')
    new_departure_time7 = departure_time7 - timedelta(minutes=1,seconds=30)
    new_departure_time_str7 = new_departure_time7.strftime('%H:%M:%S')
    filtered_row['departure_time'] = new_departure_time_str7
    ...
    stop_times_txt_data.loc[stop_times_txt_data['trip_id']==trip_id, 'stop_sequence'] += 5
    ...
    rows_to_insert = [filtered_row4,filtered_row3,filtered_row2,filtered_row1,filtered_row]
...
for trip in range(0, len(trip_ids0), 2):
    process_trip(trip_ids0[trip])
    print(ticker)
    ticker +=2

# %% Cell 27
test_output = stop_times_txt_data[stop_times_txt_data['trip_id']=='412B.1396.144.40.H.8.81851741']
test_output

# %% Cell 28
def process_trip3(trip_id):
    ...
    filtered_row1['stop_id'] = 2000921
    filtered_row2['stop_id'] = 2000931
    filtered_row3['stop_id'] = 2000991
    filtered_row4['stop_id'] = 2000996
    ...
    departure_time_str = filtered_row4['departure_time'].values[0]
    departure_time = datetime.strptime(departure_time_str, '%H:%M:%S')
    new_departure_time = departure_time - timedelta(minutes=12)
    new_departure_time_str = new_departure_time.strftime('%H:%M:%S')
    filtered_row4['departure_time'] = new_departure_time_str
    ...
    arrival_time_str4 = filtered_row3['arrival_time'].values[0]
    arrival_time4 = datetime.strptime(arrival_time_str4, '%H:%M:%S')
    new_arrival_time4 = arrival_time4 - timedelta(minutes=10)
    new_arrival_time_str4 = new_arrival_time4.strftime('%H:%M:%S')
    filtered_row3['arrival_time'] = new_arrival_time_str4

    departure_time_str4 = filtered_row3['departure_time'].values[0]
    departure_time4 = datetime.strptime(departure_time_str4, '%H:%M:%S')
    new_departure_time4 = departure_time4 - timedelta(minutes=9,seconds=30)
    new_departure_time_str4 = new_departure_time4.strftime('%H:%M:%S')
    filtered_row3['departure_time'] = new_departure_time_str4
    ...
    arrival_time_str5 = filtered_row2['arrival_time'].values[0]
    arrival_time5 = datetime.strptime(arrival_time_str5, '%H:%M:%S')
    new_arrival_time5 = arrival_time5 - timedelta(minutes=7,seconds=30)
    new_arrival_time_str5 = new_arrival_time5.strftime('%H:%M:%S')
    filtered_row2['arrival_time'] = new_arrival_time_str5

    departure_time_str5 = filtered_row2['departure_time'].values[0]
    departure_time5 = datetime.strptime(departure_time_str5, '%H:%M:%S')
    new_departure_time5 = departure_time5 - timedelta(minutes=7)
    new_departure_time_str5 = new_departure_time5.strftime('%H:%M:%S')
    filtered_row2['departure_time'] = new_departure_time_str5
    ...
    arrival_time_str6 = filtered_row1['arrival_time'].values[0]
    arrival_time6 = datetime.strptime(arrival_time_str6, '%H:%M:%S')
    new_arrival_time6 = arrival_time6 - timedelta(minutes=5)
    new_arrival_time_str6 = new_arrival_time6.strftime('%H:%M:%S')
    filtered_row1['arrival_time'] = new_arrival_time_str6

    departure_time_str6 = filtered_row1['departure_time'].values[0]
    departure_time6 = datetime.strptime(departure_time_str6, '%H:%M:%S')
    new_departure_time6 = departure_time6 - timedelta(minutes=4,seconds=30)
    new_departure_time_str6 = new_departure_time6.strftime('%H:%M:%S')
    filtered_row1['departure_time'] = new_departure_time_str6
    ...
    arrival_time_str7 = filtered_row['arrival_time'].values[0]
    arrival_time7 = datetime.strptime(arrival_time_str7, '%H:%M:%S')
    new_arrival_time7 = arrival_time7 - timedelta(minutes=2,seconds=30)
    new_arrival_time_str7 = new_arrival_time7.strftime('%H:%M:%S')
    filtered_row['arrival_time'] = new_arrival_time_str7

    departure_time_str7 = filtered_row['departure_time'].values[0]
    departure_time7 = datetime.strptime(departure_time_str7, '%H:%M:%S')
    new_departure_time7 = departure_time7 - timedelta(minutes=2)
    new_departure_time_str7 = new_departure_time7.strftime('%H:%M:%S')
    filtered_row['departure_time'] = new_departure_time_str7
...
for trip in range(1, len(trip_ids0), 2):
    process_trip3(trip_ids0[trip])
    print(ticker)
    ticker +=2

# %% Cell 30
process_trip3('412B.1396.144.4.H.8.81851741')

# %% Cell 31
test_output = stop_times_txt_data[stop_times_txt_data['trip_id']=='412B.1396.144.4.H.8.81851741']
test_output

# %% Cell 32
def process_trip4(trip_id):
    ...
    filtered_row['stop_id'] = 2000971
    filtered_row1['stop_id'] = 2000961
    filtered_row2['stop_id'] = 2000981
   

    filtered_row['stop_sequence'] = 3
    filtered_row1['stop_sequence'] = 2
    filtered_row2['stop_sequence'] = 1
    ...
    arrival_time_str6 = filtered_row1['arrival_time'].values[0]
    arrival_time6 = datetime.strptime(arrival_time_str6, '%H:%M:%S')
    new_arrival_time6 = arrival_time6 - timedelta(minutes=5,seconds=30)
    new_arrival_time_str6 = new_arrival_time6.strftime('%H:%M:%S')
    filtered_row1['arrival_time'] = new_arrival_time_str6

    departure_time_str6 = filtered_row1['departure_time'].values[0]
    departure_time6 = datetime.strptime(departure_time_str6, '%H:%M:%S')
    new_departure_time6 = departure_time6 - timedelta(minutes=5)
    new_departure_time_str6 = new_departure_time6.strftime('%H:%M:%S')
    filtered_row1['departure_time'] = new_departure_time_str6
    ...
    arrival_time_str7 = filtered_row['arrival_time'].values[0]
    arrival_time7 = datetime.strptime(arrival_time_str7, '%H:%M:%S')
    new_arrival_time7 = arrival_time7 - timedelta(minutes=3)
    new_arrival_time_str7 = new_arrival_time7.strftime('%H:%M:%S')
    filtered_row['arrival_time'] = new_arrival_time_str7

    departure_time_str7 = filtered_row['departure_time'].values[0]
    departure_time7 = datetime.strptime(departure_time_str7, '%H:%M:%S')
    new_departure_time7 = departure_time7 - timedelta(minutes=2,seconds=30)
    new_departure_time_str7 = new_departure_time7.strftime('%H:%M:%S')
    filtered_row['departure_time'] = new_departure_time_str7
    ...
    rows_to_insert = [filtered_row2,filtered_row1,filtered_row]
...
for trip in range(2, len(trip_ids0), 3):
    process_trip4(trip_ids0[trip])
    print(ticker)
    ticker +=3
'''
...
def process_trip1(trip_id):
    ...
    arrival_time = datetime.strptime(arrival_time_str, '%H:%M:%S')
    new_arrival_time = arrival_time + timedelta(minutes=1,seconds=30)
    new_arrival_time_str = new_arrival_time.strftime('%H:%M:%S')
    ...
    new_arrival_time3 = arrival_time3 + timedelta(minutes=4,seconds=30)
    ...
    new_departure_time3 = departure_time3 + timedelta(minutes=5)
    ...
    arrival_time4 = datetime.strptime(arrival_time_str4, '%H:%M:%S')
    new_arrival_time4 = arrival_time4 + timedelta(minutes=7)
    new_arrival_time_str4 = new_arrival_time4.strftime('%H:%M:%S')
    filtered_row2['arrival_time'] = new_arrival_time_str4

    departure_time_str4 = filtered_row2['departure_time'].values[0]
    departure_time4 = datetime.strptime(departure_time_str4, '%H:%M:%S')
    new_departure_time4 = departure_time4 + timedelta(minutes=7,seconds=30)
    new_departure_time_str4 = new_departure_time4.strftime('%H:%M:%S')
    ...
    arrival_time5 = datetime.strptime(arrival_time_str5, '%H:%M:%S')
    new_arrival_time5 = arrival_time5 + timedelta(minutes=9,seconds=30)
    new_arrival_time_str5 = new_arrival_time5.strftime('%H:%M:%S')
    filtered_row3['arrival_time'] = new_arrival_time_str5

    departure_time_str5 = filtered_row3['departure_time'].values[0]
    departure_time5 = datetime.strptime(departure_time_str5, '%H:%M:%S')
    new_departure_time5 = departure_time5 + timedelta(minutes=10)
    new_departure_time_str5 = new_departure_time5.strftime('%H:%M:%S')
    ...
    arrival_time6 = datetime.strptime(arrival_time_str6, '%H:%M:%S')
    new_arrival_time6 = arrival_time6 + timedelta(minutes=12)
    new_arrival_time_str6 = new_arrival_time6.strftime('%H:%M:%S')
    ...
    rows_to_insert = [filtered_row,filtered_row1,filtered_row2,filtered_row3,filtered_row4]
...
for trip1 in range(0, len(trip_ids2), 2):
    process_trip1(trip_ids2[trip1])
    ticker +=2
    print(ticker)
...
def process_trip5(trip_id):
    ...
    departure_time_str4 = filtered_row2['departure_time'].values[0]
    departure_time4 = datetime.strptime(departure_time_str4, '%H:%M:%S')
    new_departure_time4 = departure_time4 + timedelta(minutes=6,seconds=30)
    new_departure_time_str4 = new_departure_time4.strftime('%H:%M:%S')
    filtered_row2['departure_time'] = new_departure_time_str4
    ...
    arrival_time_str5 = filtered_row3['arrival_time'].values[0]
    arrival_time5 = datetime.strptime(arrival_time_str5, '%H:%M:%S')
    new_arrival_time5 = arrival_time5 + timedelta(minutes=9)
    new_arrival_time_str5 = new_arrival_time5.strftime('%H:%M:%S')
    filtered_row3['arrival_time'] = new_arrival_time_str5

    departure_time_str5 = filtered_row3['departure_time'].values[0]
    departure_time5 = datetime.strptime(departure_time_str5, '%H:%M:%S')
    new_departure_time5 = departure_time5 + timedelta(minutes=9,seconds=30)
    new_departure_time_str5 = new_departure_time5.strftime('%H:%M:%S')
    filtered_row3['departure_time'] = new_departure_time_str5
...
# %% Cell 48
test_output = stop_times_txt_data[stop_times_txt_data['trip_id']=='412C.1396.144.4.H.8.81851740']
test_output

# %% Cell 49
process_trip5('412C.1396.144.4.H.8.81851740')

# %% Cell 50
ticker = 1

for trip1 in range(1, len(trip_ids2), 2):
    process_trip5(trip_ids2[trip1])
    ticker +=2
    print(ticker)

# %% Cell 51
def process_trip6(trip_id):
    ...
    arrival_time_str4 = filtered_row2['arrival_time'].values[0]
    arrival_time4 = datetime.strptime(arrival_time_str4, '%H:%M:%S')
    new_arrival_time4 = arrival_time4 + timedelta(minutes=8)
    new_arrival_time_str4 = new_arrival_time4.strftime('%H:%M:%S')
    filtered_row2['arrival_time'] = new_arrival_time_str4

    departure_time_str4 = filtered_row2['departure_time'].values[0]
    departure_time4 = datetime.strptime(departure_time_str4, '%H:%M:%S')
    new_departure_time4 = departure_time4 + timedelta(minutes=8)
    new_departure_time_str4 = new_departure_time4.strftime('%H:%M:%S')
    filtered_row2['departure_time'] = new_departure_time_str4
...
for trip1 in range(2, len(trip_ids2), 3):
    process_trip6(trip_ids2[trip1])
    ticker +=3
    print(ticker)
'''

# %% Cell 53
stop_times_txt_data.to_csv("C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_bradfield_malabar&sydenham/stop_times.txt", index=False)

# %% Cell 54
shapefile_path_gtfs1 = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/bradfield_malabar&sydenham.zip'
