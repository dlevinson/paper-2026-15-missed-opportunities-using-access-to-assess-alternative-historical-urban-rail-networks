# Exported from THESISCODE Millsv2.ipynb. Outputs removed; execution order preserved where present.
...
def process_trip3(trip_id):
    ...
    filtered_row['stop_sequence'] = 4
    filtered_row1['stop_sequence'] = 3
    filtered_row2['stop_sequence'] = 2
    filtered_row3['stop_sequence'] = 1
    ...
    stop_times_txt_data.loc[stop_times_txt_data['trip_id']==trip_id, 'stop_sequence'] += 4
    ...
    rows_to_insert = [filtered_row3,filtered_row2,filtered_row1,filtered_row]
...
# %% Cell 43
test_output = stop_times_txt_data[stop_times_txt_data['trip_id']=='412C.807.155.36.H.8.81899777']
test_output
...
# %% Cell 47
shapefile_path_gtfs1 = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/Mills_v4.zip'
