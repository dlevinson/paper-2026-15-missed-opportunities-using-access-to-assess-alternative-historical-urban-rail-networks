# Exported from THESISCODE Mills Plan_metro_v2.ipynb. Outputs removed; execution order preserved where present.
...
# %% Cell 15
trips_txt_path = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_combination_metro/trips.txt'
...
# %% Cell 18
stop_times_txt_path = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_combination_metro/stop_times.txt'
...
def process_trip3(trip_id):
    ...
    filtered_row1['stop_id'] = 2000911
    filtered_row2['stop_id'] = 2000921
    filtered_row3['stop_id'] = 2000931
    filtered_row4['stop_id'] = 2000991
    filtered_row5['stop_id'] = 2000996

    filtered_row['stop_sequence'] = 6
    filtered_row1['stop_sequence'] = 5
    filtered_row2['stop_sequence'] = 4
    filtered_row3['stop_sequence'] = 3
    filtered_row4['stop_sequence'] = 2
    filtered_row5['stop_sequence'] = 1
    ...
    new_arrival_time8 = arrival_time8 - timedelta(minutes=10)
    ...
    new_departure_time8 = departure_time8 - timedelta(minutes=10)
    ...
    new_arrival_time = arrival_time - timedelta(minutes=7,seconds=0)
    ...
    new_departure_time = departure_time - timedelta(minutes=6, seconds =45)
    ...
    new_arrival_time4 = arrival_time4 - timedelta(minutes=5, seconds =0)
    ...
    new_arrival_time5 = arrival_time5 - timedelta(minutes=4,seconds=0)
    ...
    new_departure_time5 = departure_time5 - timedelta(minutes=3,seconds=45)
    ...
    new_arrival_time6 = arrival_time6 - timedelta(minutes=3)
    ...
    new_departure_time6 = departure_time6 - timedelta(minutes=2,seconds=45)
    ...
    new_arrival_time7 = arrival_time7 - timedelta(minutes=1,seconds=15)
    ...
    new_departure_time7 = departure_time7 - timedelta(minutes=1)
    ...
    stop_times_txt_data.loc[stop_times_txt_data['trip_id']==trip_id, 'stop_sequence'] += 6
    ...
    rows_to_insert = [filtered_row5,filtered_row4,filtered_row3,filtered_row2,filtered_row1,filtered_row]
...
def process_trip5(trip_id):
    ...
    arrival_time = datetime.strptime(arrival_time_str, '%H:%M:%S')
    new_arrival_time = arrival_time + timedelta(minutes=1)
    new_arrival_time_str = new_arrival_time.strftime('%H:%M:%S')
    filtered_row['arrival_time'] = new_arrival_time_str

    departure_time_str = filtered_row['departure_time'].values[0]
    departure_time = datetime.strptime(departure_time_str, '%H:%M:%S')
    new_departure_time = departure_time + timedelta(minutes=1,seconds=15)
    new_departure_time_str = new_departure_time.strftime('%H:%M:%S')
    ...
    new_arrival_time3 = arrival_time3 + timedelta(minutes=2,seconds=45)
    ...
    new_departure_time3 = departure_time3 + timedelta(minutes=3,seconds=0)
    ...
    arrival_time4 = datetime.strptime(arrival_time_str4, '%H:%M:%S')
    new_arrival_time4 = arrival_time4 + timedelta(minutes=4)
    new_arrival_time_str4 = new_arrival_time4.strftime('%H:%M:%S')
    filtered_row2['arrival_time'] = new_arrival_time_str4

    departure_time_str4 = filtered_row2['departure_time'].values[0]
    departure_time4 = datetime.strptime(departure_time_str4, '%H:%M:%S')
    new_departure_time4 = departure_time4 + timedelta(minutes=4,seconds=15)
    new_departure_time_str4 = new_departure_time4.strftime('%H:%M:%S')
    ...
    arrival_time5 = datetime.strptime(arrival_time_str5, '%H:%M:%S')
    new_arrival_time5 = arrival_time5 + timedelta(minutes=5, seconds=30)
    new_arrival_time_str5 = new_arrival_time5.strftime('%H:%M:%S')
    filtered_row3['arrival_time'] = new_arrival_time_str5

    departure_time_str5 = filtered_row3['departure_time'].values[0]
    departure_time5 = datetime.strptime(departure_time_str5, '%H:%M:%S')
    new_departure_time5 = departure_time5 + timedelta(minutes=5,seconds=45)
    new_departure_time_str5 = new_departure_time5.strftime('%H:%M:%S')
    ...
    filtered_row1['stop_sequence'] =filtered_row['stop_sequence'] + 2
    filtered_row2['stop_sequence'] =filtered_row['stop_sequence'] + 3
    filtered_row3['stop_sequence'] =filtered_row['stop_sequence'] + 4
    filtered_row4['stop_sequence'] =filtered_row['stop_sequence'] + 5
    filtered_row5['stop_sequence'] =filtered_row['stop_sequence'] + 6
...
# %% Cell 43
stop_times_txt_data.to_csv("C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/new_base_case_with_smw_v4_combination_metro/stop_times.txt", index=False)
...
# %% Cell 46
shapefile_path_gtfs1 = 'C:/Users/m1llz/Downloads/UNI FILES/UNISTUFF V2/combination_metro.zip'
...
travel_time_matrix = r5py.TravelTimeMatrixComputer(
    ...
    departure=datetime.datetime(2024, 8, 28, 8, 10, 00),
